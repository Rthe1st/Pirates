...
public class DesignShipSubModeOptions extends Fragment {	
	...
	public View onCreateView(LayoutInflater inflater, 
		...
		Configuration config = this.getResources().getConfiguration();
			View inflatedView = inflater.inflate(R.layout.design_ship_sub_mode_options, container, false);
			LinearLayout castLayout = ((LinearLayout)inflatedView.findViewById(R.id.shipSubMode));
